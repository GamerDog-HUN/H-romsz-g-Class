...
#0
print("Háromszögek feldolghozása 'class' segítségével")

#1
a = float(input("a =").replace(',' , '.'))
b = float(input("b =").replace(',' , '.'))
c = float(input("c =").replace(',' , '.'))
...
#A split az adatSort részekre bontja és elhelyezi egy szöveges tupple-be
# "*" operárot felosztja a tupple-t és hozzá rendeli a megfelelő paraméterekhez
